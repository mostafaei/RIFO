...
public class WFQRIFOOutputPort extends OutputPort {
    ...
    WFQRIFOOutputPort(NetworkDevice ownNetworkDevice, NetworkDevice targetNetworkDevice, Link link, long maxQueueSize, int sampleCount, float kValue) {
