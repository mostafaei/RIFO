...
import ch.ethz.systems.netbench.xpt.rifo.ports.RIFO_WFQ.WFQRIFOOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.simple.simpleudp.SimpleUdpTransportLayerGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.AFQ.AFQOutputPortGenerator;
// import ch.ethz.systems.netbench.xpt.sppifo.ports.CSFQ.CSFQOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.FIFO.FIFOOutputPortGenerator;
// import ch.ethz.systems.netbench.xpt.sppifo.ports.HCSFQ.HCSFQOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.PIFO.PIFOOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.SPPIFO.SPPIFOOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.RIFO.RIFOOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.Greedy.GreedyOutputPortGenerator_Advanced;
import ch.ethz.systems.netbench.xpt.rifo.ports.Greedy.GreedyOutputPortGenerator_Simple;
import ch.ethz.systems.netbench.xpt.rifo.ports.SPPIFO_WFQ.WFQSPPIFOOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.AIFO.AIFOOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.AIFO_WFQ.WFQAIFOOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.TailDrop.TailDropOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.rifo.ports.PIFO_WFQ.WFQPIFOOutputPortGenerator;
...
class InfrastructureSelector {
    ...
    static OutputPortGenerator selectOutputPortGenerator() {
        ...
        switch (Simulator.getConfiguration().getPropertyOrFail("output_port")) {
            ...
            case "wfqaifo":
                return new WFQAIFOOutputPortGenerator(
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_max_size_packets"),
            ...
            case "wfqrifo":
                return new WFQRIFOOutputPortGenerator(
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_max_size_packets"),
                        Simulator.getConfiguration().getIntegerPropertyOrFail("sample_count"),
                        (float) Simulator.getConfiguration().getDoublePropertyOrFail("k_value")
                );
            ...
            case "rifo":
                return new RIFOOutputPortGenerator(
                        Simulator.getConfiguration().getLongPropertyOrFail("output_port_max_size_packets"),
                        Simulator.getConfiguration().getIntegerPropertyOrFail("sample_count"),
                        (float) Simulator.getConfiguration().getDoublePropertyOrFail("k_value")
                );
