...
saveDir='projects/rifo/plots/rifo_evaluation/fairness/web_search_workload/'
file = "projects/rifo/plots/rifo_evaluation/fairness/web_search_workload/pFabric_less_100KB_99th_fct_ms.dat"
r = open(file, 'r')
lines = r.readlines()
...
file = "projects/rifo/plots/rifo_evaluation/fairness/web_search_workload/pFabric_less_100KB_mean_fct_ms.dat"
r = open(file, 'r')
lines = r.readlines()
for i, line in enumerate(lines):
    l=re.findall("[-+]?[.]?[\d]+(?:,\d\d\d)*[\.]?\d*(?:[eE][-+]?\d+)?", line)
...
file = "projects/rifo/plots/rifo_evaluation/fairness/web_search_workload/pFabric_geq_1MB_mean_fct_ms.dat"
r = open(file, 'r')
lines = r.readlines()
for i, line in enumerate(lines):
    l=re.findall("[-+]?[.]?[\d]+(?:,\d\d\d)*[\.]?\d*(?:[eE][-+]?\d+)?", line)
...
ax.grid(color='black', ls = '--',dashes=(5, 15), lw = 0.2,alpha=1)
fig.tight_layout() 
name='avgFCTLarge-websearch-wfq'
plt.savefig(saveDir+'%s.pdf'%name,format="pdf", bbox_inches='tight', pad_inches=0.05)
plt.close()
