...
saveDir='projects/rifo/plots/rifo_evaluation/pFabric/web_search_workload_T/'
file = "projects/rifo/plots/rifo_evaluation/pFabric/web_search_workload/pFabric_less_100KB_99th_fct_ms.dat"
r = open(file, 'r')
lines = r.readlines()
...
file = "projects/rifo/plots/rifo_evaluation/pFabric/web_search_workload/pFabric_less_100KB_mean_fct_ms.dat"
r = open(file, 'r')
lines = r.readlines()
for i, line in enumerate(lines):
    l=re.findall("[-+]?[.]?[\d]+(?:,\d\d\d)*[\.]?\d*(?:[eE][-+]?\d+)?", line)
...
file = "projects/rifo/plots/rifo_evaluation/pFabric/web_search_workload/pFabric_geq_1MB_mean_fct_ms.dat"
r = open(file, 'r')
lines = r.readlines()
for i, line in enumerate(lines):
    l=re.findall("[-+]?[.]?[\d]+(?:,\d\d\d)*[\.]?\d*(?:[eE][-+]?\d+)?", line)
